...
Parq now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare <proposal-name> <url> <payment_count> <block_start> <parq_address> <monthly_payment_xmx>
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PARQ, _12_ times over the course of a year totaling _24000_ PARQ.
...
mnbudget submit <proposal-name> <url> <payment_count> <block_start> <parq_address> <monthly_payment_xmx> <collateral_hash>
...
When block `1000000` is reached you'll receive a payment for `1200` PARQ.
 ...
 * vote-many          - Vote on a Parq initiative
 * vote-alias         - Vote on a Parq initiative
 * vote               - Vote on a Parq initiative/budget
