...
In order to support loading of multiple wallets in parq-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is parq.cpp.
...
parq.cpp is the entry point into parq-qt, and as such, will require some minor modifications to provide hooks for
