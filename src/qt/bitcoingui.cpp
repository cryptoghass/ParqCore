                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    labelPARQIcon = new QLabel();
    //labelPARQIcon->setObjectName("XmxIcon");
    //labelPARQIcon->setStyleSheet("QLabel {font-family: Segoe UI, Tahoe, Georgia, sans-serif, font-weight: 900; font-size: 14px; color: #606060; }");
    labelPARQIcon->setPixmap(QIcon(":/icons/label_xmx").pixmap(37, 11));
    frameBlocksLayout->addStretch();
    frameBlocksLayout->addWidget(labelPARQIcon);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Parq address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PARQ:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About Parq Core"), this);
    aboutAction->setStatusTip(tr("Show information about Parq Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Parq"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Parq addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify_menu"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Parq addresses"));
    ...
    openAction->setStatusTip(tr("Open a PARQ:URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Parq Core help message to get a list with possible Parq command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Parq Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Parq network", "", count));
}
...
{
    QString strTitle = tr("Parq"); // default title
