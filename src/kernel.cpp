...
{
    //Parq will hash in the transaction hash and the index number in order to make sure each hash is unique
...
{
	// PARQ TODO: renable once stacking generates a checkpoint
    /*
