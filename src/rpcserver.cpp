...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Parq features */
        {"parq", "masternode", &masternode, true, true, false},
        {"parq", "masternodelist", &masternodelist, true, true, false},
        {"parq", "mnbudget", &mnbudget, true, true, false},
        {"parq", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"parq", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"parq", "mnsync", &mnsync, true, true, false},
        {"parq", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"parq", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use parqd, or the -server option to parq-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> parq-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12416/\n";
}
