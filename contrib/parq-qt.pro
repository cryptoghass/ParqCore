...
RESOURCES += src/qt/parq.qrc src/qt/parq_locale.qrc

TRANSLATIONS += src/qt/locale/parq_bg.ts \
                src/qt/locale/parq_de.ts \
                src/qt/locale/parq_en.ts \
                src/qt/locale/parq_es.ts \
                src/qt/locale/parq_fi.ts \
                src/qt/locale/parq_fr.ts \
                src/qt/locale/parq_it.ts \
                src/qt/locale/parq_ja.ts \
                src/qt/locale/parq_pl.ts \
                src/qt/locale/parq_pt.ts \
                src/qt/locale/parq_ru.ts \
                src/qt/locale/parq_sk.ts \
                src/qt/locale/parq_sv.ts \
                src/qt/locale/parq_vi.ts \
                src/qt/locale/parq_zh_CN.ts \
                src/qt/locale/parq_zh_TW.ts